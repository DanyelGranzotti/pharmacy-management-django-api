...
ROOT_URLCONF = 'pharmacy_management_django_api.urls'
...
WSGI_APPLICATION = 'pharmacy_management_django_api.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'NAME': env('DB_NAME', default='pharmacy_management'),
...
AUTH_USER_MODEL = 'pharmacy_management_app.User'
